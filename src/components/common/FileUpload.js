...
class FileUpload extends Component {
	...
	render()
	{
		//image size limit when updating
		// {/* lit image <= 5MB */}
		...
		return (
			<Dragger {...props}>
				...
				<p className="ant-upload-text">Drag and drop or click to add an image</p>
				<p className="ant-upload-hint">{`Support upload. Limited to ${limit}MB or less`}</p>
			</Dragger>
		);
	}
}
